#!/bin/bash
#
#   Check whether there exists a WLAN network connection to the local router
...
function netRestart() {
	/usr/bin/logger "No networkconnection, restarting wlan0"
...
function reboot() {
	/usr/bin/logger "No networkconnection, wlan0 unsuccesfull, rebooting"
