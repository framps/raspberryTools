...
GIT_DATE="$Date: 2016-04-09 15:05:21 +0200$"
GIT_DATE_ONLY=${GIT_DATE/: /}
GIT_DATE_ONLY=$(echo $GIT_DATE | cut -f 2 -d ' ')
GIT_TIME_ONLY=$(echo $GIT_DATE | cut -f 3 -d ' ') 
GIT_COMMIT="$Sha1: 0438a0328a2212a997c37915bb97d67120e7fd02$"
...
MSG_CHECK_OUTPUT=16
MSG_EN[$MSG_CHECK_OUTPUT]="RNI016I: Check logile %1 for sensitive data before publishing"
